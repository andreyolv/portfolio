...
def concat_tables():
    df1 = pd.read_excel(path_file+'temp_data/df1.xlsx')
    df2 = pd.read_excel(path_file+'temp_data/df2.xlsx')
...
def verify_and_load_excel():
    raw_data = pd.read_excel(path_file+'raw_data/raw_data.xlsx')
